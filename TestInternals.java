...
public class TestInternals extends ApptBook.TestInvariantChecker {
    ...
    public void testF9() {
        Node n0= newNode(e3, null, null);
        Node n0a= newNode(e3, null, null);
        Node n1= newNode(e3, n0, n0a);
        Node n1a= newNode(e3, n0a, n0a);
        Node n2= newNode(e3, n1a, n1);
        Node n2a= newNode(e3, n1a, n1a);
        Node n3= newNode(e3, n2, n2a);
        Node n3a= newNode(e3, n2a, n2a);
        Node n4= newNode(e3, n3a, n3);
        Node n4a= newNode(e3, n3a, n3a);
        Node n5= newNode(e3, n4, n4a);
        Node n5a= newNode(e3, n4a, n4a);
        Node n6= newNode(e3, n5a, n5);
        Node n6a= newNode(e3, n5a, n5a);
        Node n7= newNode(e3, n6, n6a);
        Node n7a= newNode(e3, n6a, n6a);
        Node n8= newNode(e3, n7a, n7);
        Node n8a= newNode(e3, n7a, n7a);
        Node n9= newNode(e3, n8, n8a);
        Node n9a= newNode(e3, n8a, n8a);
    ...
    public void testI9() {
        ...
        Node n1= newNode(e3, n0, n0a);
        Node n1a= newNode(e3, n0a, n0a);
        Node n2= newNode(e3, n1, n1a);
        Node n2a= newNode(e3, n1a, n1a);
        Node n3= newNode(e3, n2, n2a);
        Node n3a= newNode(e3, n2a, n2a);
        Node n4= newNode(e3, n3, n3a);
        Node n4a= newNode(e3, n3a, n3a);
        Node n5= newNode(e3, n4, n4a);
        Node n5a= newNode(e3, n4a, n4a);
        Node n6= newNode(e3, n5, n5a);
        Node n6a= newNode(e3, n5a, n5a);
        Node n7= newNode(e3, n6, n6a);
        Node n7a= newNode(e3, n6a, n6a);
        Node n8= newNode(e3, n7, n7a);
        Node n8a= newNode(e3, n7a, n7a);
        Node n9= newNode(e3, n8, n8a);
        Node n9a= newNode(e3, n8a, n8a);
